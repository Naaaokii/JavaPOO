...
public class Contact implements Comparable<Contact> {
    ...
    // Déclarer une constante publique et statique nommée "SEPARATEUR" qui contient
    // un séparateur de chaîne de caractères
    ...
    public void setPrenom(String prenom) {
        // Mettre la première lettre du prénom en majuscule avant de l'assigner à
        // l'attribut "prenom"
    ...
    // Déclarer une méthode nommée "setTelephone" qui prend en argument une chaîne
    // de caractères et qui peut lever une ParseException
    public void setTelephone(String telephone) throws ParseException { // exception d'analyse

        // Vérifier le format du numéro de téléphone
        // L'expression régulière permet de vérifier si le numéro est préfixé par "+33",
        // "0033" ou simplement "0" et s'il est espacé par "", "." ou "-"
        ...
        if (testTelephone.matches()) {
            ...
            // Si oui, définir l'attribut "telephone" de l'objet avec la valeur du paramètre
            // "telephone"
            this.telephone = telephone;

        } else {

            // Si non, lever une ParseException avec le message "Le format du numéro est
            // incorrect"
    ...
    // Déclarer une méthode nommée "setMail" qui prend en argument une chaîne de
    // caractères et qui peut lever une ParseException
    public void setMail(String mail) throws ParseException {
        ...
        if (testMail.matches()) {
            ...
            // Si oui, définir l'attribut "mail" de l'objet avec la valeur du paramètre
            // "mail"
            this.mail = mail;

        } else {

            // Si non, lever une ParseException avec le message "Le format du mail est
            // incorrect"
    ...
    // Déclarer une méthode nommée "setDateNaissance" qui prend en argument une
    // chaîne de caractères et qui peut lever une ParseException
    public void setDateNaissance(String dateNaissance) throws ParseException {
        ...
        // Définir l'attribut "dateNaissance" de l'objet avec la valeur de la chaîne de
        // caractères (qui se fait parse()) selon le format de date)
        // Cette méthode renvoie une date ou une valeur nulle (dans le cas où la chaîne
        // n'a pas été traitée en raison d'une erreur)
        this.dateNaissance = dateFormat.parse(dateNaissance);
    }

    // Déclarer une méthode nommée "sauvegarderContact" qui peut lever une
    // IOException
    public void sauvegarderContact() throws IOException { // exception fichier

        // Créer un objet PrintWriter qui écrira dans un fichier nommé "contacts.csv" en
        // utilisant l'option "true" pour ajouter du contenu à la fin du fichier
    ...
    // Déclarer une méthode statique nommée "listerContacts" qui renvoie une
    // ArrayList de Contact et qui peut lever une IOException
    public static ArrayList<Contact> listerContacts() throws IOException {
        ...
        try {
            ...
            while (ligne != null) {
                ...
                // Séparer les différentes informations de la ligne en utilisant le séparateur
                // défini par la constante "SEPARATEUR"
            ...
            // Afficher le message "Erreur de lecture sur le fichier" en cas d'exception
            // IOException
    ...
    @Override
    // Redéfinir la méthode toString() héritée de la classe Object pour renvoyer une
    // chaîne de caractères représentant l'objet Contact
